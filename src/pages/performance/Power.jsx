    ...
    <div className='overflow-x-clip overflow-y-auto blue-scrollbar scrollbar relative font-[100] w-[calc(100vw-280px)] max-[1000px]:w-full h-[calc(100svh-77px)]  pl-8 pt-10'>
      <div className='relative h-full w-full  flex flex-col gap-2'>
        <div className="pr-8 titlebar w-full flex text-[40px] items-start justify-between">
          <div className="title">Power Settings</div>
        ...
        <main className='pr-8 flex flex-col gap-10 items-start'>
          <div className="content text-[18px] text-[#dbdbdb] relative z-1">Windows power plans determine how your system balances performance and power consumption. Selecting the appropriate power plan helps your system deliver the best possible performance, especially during demanding tasks such as gaming or multitasking.</div>
          <div className="art1 flex flex-col gap-1 items-start ">
            <div className="find font-[400] text-[22px]">Desktop (Windows 10 & Windows 11)</div>
          ...
          <div className="art3 flex flex-col gap-1 items-start mb-10">
            ...
            <div className="comp text-[rgb(80,160,255)] font-[400] relative z-1">Note: Windows 10 doesn't provide a separate performance mode for when your laptop is plugged in. Enabling the High Performance power plan applies it to both plugged-in and battery use, which may increase battery usage when the laptop is unplugged.</div>
            <div className="buttons w-full flex items-center gap-8 max-[438px]:flex-col-reverse   max-[438px]:gap-2 max-[438px]:">
              <Link to='/performance/startup' className='flex items-center justify-center w-[170px] max-[438px]:w-full relative z-1 mt-4 text-[18px] bg-[rgb(0,16,32)] cursor-pointer hover:bg-[rgb(0,32,64)]  font-[400] p-3 px-8 border-b-2 text-[rgb(0,128,255)] border-[rgb(0,128,255)] '>← Previous</Link>
              <Link to='/performance/storage' className='flex items-center justify-center w-[170px] max-[438px]:w-full relative z-1 mt-4 text-[18px] bg-[rgb(0,16,32)] cursor-pointer hover:bg-[rgb(0,32,64)]  font-[400] p-3 px-8 border-b-2 text-[rgb(0,128,255)] border-[rgb(0,128,255)] '>Next →</Link>
            </div>
          </div>
