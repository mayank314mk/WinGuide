    ...
    <div className='overflow-x-clip overflow-y-auto blue-scrollbar scrollbar relative font-[100] w-[calc(100vw-280px)] max-[1000px]:w-full h-[calc(100svh-77px)]  pl-8 pt-10'>
      <div className='relative h-full w-full  flex flex-col gap-2'>
        <div className="pr-8 titlebar w-full flex text-[40px] items-start justify-between">
          <div className="title">Maintain Free Space</div>
        ...
        <main className='pr-8 flex flex-col gap-10 items-start'>
          <div className='flex flex-col gap-4 items-start'>
            <div className="content text-[18px] text-[#dbdbdb] relative z-1">Keeping sufficient free space on your Windows drive helps maintain system performance and allows Windows to operate efficiently. When the drive becomes nearly full, Windows may slow down, updates may fail, and there may not be enough space for temporary files or virtual memory.</div>
            <div className="content text-[18px] text-[#dbdbdb] relative z-1">It is recommended to keep at least 15-20% free space on your Windows drive.</div>
          </div>
          <div className="art1 flex flex-col gap-1 items-start ">
            <div className="find font-[400] text-[22px]">Ways to Free Up Space</div>
            <div className="content text-[18px] text-[#dbdbdb] relative z-1">1. Uninstall applications you no longer use.</div>
            {/* <img src="/assets/images/ss1.PNG" className='relative z-1 py-4' alt="" /> */}
            <div className="content text-[18px] text-[#dbdbdb] relative z-1">2. Delete unnecessary files such as downloads, videos, or duplicate files.</div>
            <div className="content text-[18px] text-[#dbdbdb] relative z-1">3. Empty the Recycle Bin.</div>
            {/* <img src="/assets/images/ss1.PNG" className='relative z-1 py-4' alt="" /> */}
            <div className="content text-[18px] text-[#dbdbdb] relative z-1">4. Move large personal files to another drive, if available.</div>
          ...
          <div className="art3 flex flex-col gap-1 items-start mb-10">
            ...
            <div className="comp text-[rgb(80,160,255)] font-[400] relative z-1">Note: The Windows drive is the partition where Windows is installed, usually Local Disk (C:). If your computer has only one drive, try to maintain at least 15-20% free space whenever possible.</div>
            <div className="buttons w-full flex items-center gap-8 max-[438px]:flex-col-reverse   max-[438px]:gap-2 max-[438px]:">
              <Link to='/performance/power' className='flex items-center justify-center w-[170px] max-[438px]:w-full relative z-1 mt-4 text-[18px] bg-[rgb(0,16,32)] cursor-pointer hover:bg-[rgb(0,32,64)]  font-[400] p-3 px-8 border-b-2 text-[rgb(0,128,255)] border-[rgb(0,128,255)] '>← Previous</Link>
              <Link to='/performance/antivirus' className='flex items-center justify-center w-[170px] max-[438px]:w-full relative z-1 mt-4 text-[18px] bg-[rgb(0,16,32)] cursor-pointer hover:bg-[rgb(0,32,64)]  font-[400] p-3 px-8 border-b-2 text-[rgb(0,128,255)] border-[rgb(0,128,255)] '>Next →</Link>
            </div>
          </div>
