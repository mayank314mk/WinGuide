    ...
    <div className=' relative font-[100] w-[calc(100vw-280px)] max-[1000px]:w-full h-[calc(100svh-77px)]  pl-8 pt-10 '>
      <div className='relative h-full w-full overflow-clip flex flex-col gap-2'>
        <div className="pr-[34px] titlebar w-full flex text-[40px] items-start justify-between">
          <div className="title">WinGuide: Performance</div>
        ...
        <main className='pr-8 flex flex-col gap-4 items-start h-full'>
          <div className="content text-[18px] text-[#dbdbdb] relative z-1">Boost your Windows PC with safe, effective
            optimizations that improve performance while
            preserving stability, security, and the
            Windows experience.</div>
          <div className="comp text-[rgb(80,160,255)] font-[400] relative z-1">Supports Windows 10 & Windows 11</div>
          <Link to='/performance/drivers' className='relative z-1 mt-4 text-[18px] bg-[rgb(0,16,32)] cursor-pointer hover:bg-[rgb(0,32,64)]  font-[400] p-3 px-8 border-b-2 text-[rgb(0,128,255)] border-[rgb(0,128,255)] '>Get Started →</Link>
